...
export default function FingerprintImpressionsServicePage() {
  const [activeCategory, setActiveCategory] = useState<"all" | "fingerprints" | "impressions" | "support">("all");
  ...
  const [formData, setFormData] = useState({
    ...
    examinationType: "Latent Fingerprint Development & Examination",
    caseBrief: ""
  });
  ...
  // 10 Core Fingerprint & Impression Services Offered
  const servicesList = [
    {
      code: "FPR-PRINT-01",
      title: "Latent Fingerprint Development & Examination",
      category: "fingerprints",
      icon: Fingerprint,
      desc: "Chemical and physical latent print processing using Ninhydrin, Cyanoacrylate fuming, fluorescent powders, and RUVIS UV imaging."
    },
    {
      code: "FPR-PRINT-02",
      title: "Fingerprint Identification & Verification",
      category: "fingerprints",
      icon: ShieldCheck,
      desc: "Friction ridge analysis evaluating minutiae characteristics (bifurcations, ridge endings, dots) following ACE-V methodology."
    },
    {
      code: "FPR-PRINT-03",
      title: "Palm Print Examination & Comparison",
      category: "fingerprints",
      icon: Search,
      desc: "Detailed palmar ridge comparison analyzing hypothenar, thenar, and interdigital zones against questioned palm impressions."
    },
    {
      code: "FPR-IMP-01",
      title: "Footprint & Footwear Impression Analysis",
      category: "impressions",
      icon: Footprints,
      desc: "Electrostatic dust lifting, 3D dental stone casting, outsole wear pattern matching, and manufacturing defect comparison."
    },
    {
      code: "FPR-IMP-02",
      title: "Tire Track Impression Examination",
      category: "impressions",
      icon: Layers,
      desc: "Analysis of tread pitch patterns, track width measurements, wear anomalies, and vehicle tire brand matching."
    },
    {
      code: "FPR-IMP-03",
      title: "Tool Mark & Impression Analysis",
      category: "impressions",
      icon: Wrench,
      desc: "Microscopic comparison of striated and impressed tool marks from pry bars, bolt cutters, screwdrivers, and locks."
    },
    {
      code: "FPR-SUP-01",
      title: "Scene Fingerprint Documentation & Collection",
      category: "support",
      icon: Search,
      desc: "On-site crime scene latent print lifting, macro-photographic evidence preservation, and chain of custody documentation."
    },
    {
      code: "FPR-PRINT-04",
      title: "Fingerprint Database Comparison Support",
      category: "fingerprints",
      icon: Database,
      desc: "Preparation of standardized card extractions for AFIS/NAFIS database searches and candidate matching."
    },
    {
      code: "FPR-SUP-02",
      ...
      category: "support",
      icon: Scale,
      desc: "Formulating court-admissible Section 45 opinion certificates, comparative photographic charts, and sworn testimony."
    },
    {
      code: "FPR-SUP-03",
      title: "Consultation for Criminal, Civil & Corporate Cases",
      category: "support",
      icon: FileText,
      desc: "Independent technical advisory for corporate theft investigations, disputed contracts, forged documents, and defense reviews."
    }
  ];

  // 5-Stage ACE-V Examination Workflow
  const processSteps = [
    {
      step: "01",
      title: "Analysis (Substrate & Ridge Flow)",
      desc: "Evaluating impression substrate, development medium, matrix quality, clarity, and level 1-3 ridge detail parameters.",
      tag: "ACE-V STEP 1"
    },
    {
      step: "02",
      title: "Comparison (Minutiae Matching)",
      desc: "Side-by-side microscopic comparison of questioned prints against known reference exemplars under high magnification.",
      tag: "ACE-V STEP 2"
    },
    {
      step: "03",
      title: "Evaluation (Identity Conclusion)",
      desc: "Formulating objective scientific conclusions: Identification (Individualization), Exclusion, or Inconclusive.",
      tag: "ACE-V STEP 3"
    },
    {
      step: "04",
      title: "Independent Blind Verification",
      desc: "Peer-review audit by a secondary certified fingerprint examiner to confirm matching points independently.",
      tag: "ACE-V STEP 4"
    },
    {
      step: "05",
      title: "Court-Ready Forensic Reporting",
      desc: "Formulating Section 45 Indian Evidence Act reports with photographic enlargement charts and ridge minutiae mapping.",
  ...
  const pillars = [
    {
      title: "ACE-V Methodology Adherence",
      desc: "Every friction ridge comparison follows the international ACE-V (Analysis, Comparison, Evaluation, Verification) forensic framework.",
      icon: Fingerprint,
      node: "01 // ACE-V METHOD"
    },
    {
      title: "Advanced Chemical & Optical Development",
      desc: "Equipped with cyanoacrylate fuming chambers, Ninhydrin development, and forensic macro-photography light sources.",
      icon: Microscope,
      node: "02 // OPTICAL LAB"
    },
    {
      title: "Section 45 Indian Evidence Act Compliance",
      desc: "Our reports and comparative charts are formulated for submission in High Courts, District Courts, and Judicial Magistrates.",
      icon: Scale,
      node: "03 // JUDICIAL STANDARDS"
    },
    {
      title: "Dual Independent Peer Verification",
      desc: "Every positive identification is independently verified by a second certified fingerprint expert before final report issuance.",
      icon: ShieldCheck,
      node: "04 // DUAL VERIFIED"
    },
    {
      title: "Strict Chain of Custody Security",
      desc: "Original impression lifts, 3D castings, and forensic evidence cards are secured under strict chain of custody protocols.",
      icon: Lock,
    ...
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-[#00d4ff]/30 selection:text-white pb-24 overflow-x-hidden relative">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden border-b border-cyan-900/30 z-10">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img
            src="/design/5.png"
            alt="Fingerprint & Impression Examination Background"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-wrap items-center justify-between gap-4 pb-8 mb-8 border-b border-slate-800/80">
            <div className="flex items-center gap-2 text-xs font-mono text-slate-400">
              ...
              <ChevronRight className="w-3 h-3 text-slate-600" />
              <span className="text-[#00d4ff] font-bold">Fingerprint & Impression Examination</span>
            </div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/90 border border-slate-800 text-[11px] font-mono text-[#00d4ff]">
              ...
              <span>SERVICE CODE: SRV-FPR-07</span>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="lg:col-span-7 space-y-6">
              ...
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/30 text-xs font-bold text-[#00d4ff] uppercase tracking-widest backdrop-blur-md">
                <Fingerprint className="w-4 h-4 text-[#00d4ff]" /> FORENSIC FINGERPRINT & IMPRESSION LABORATORY
              </motion.div>
              ...
              <motion.h1 variants={fadeUp} className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.12]">
                Fingerprint & <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Impression Examination</span>
              </motion.h1>

              <motion.p variants={fadeUp} className="text-slate-300 text-base md:text-lg leading-relaxed font-normal">
                Friction ridge patterns on human fingers, palms, and soles provide uniquely infallible evidence in forensic science. Beyond fingerprints, footwear impressions, tire tracks, and tool marks leave vital physical evidence at crime scenes and incident locations. At <strong className="text-white font-semibold">Skyline Centre of Excellence</strong>, we provide scientific Fingerprint &amp; Impression Examination Services utilizing international ACE-V methodology, chemical latent print development, electrostatic dust lifting, 3D casting, and court-admissible Section 45 expert reporting.
              </motion.p>
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 pt-4">
                ...
                >
                  ...
                  <span>Request Impression Examination</span>
                  <ArrowRight className="w-4 h-4" />
                </a>
                <a
                  href="#fingerprint-services"
                ...
                >
                  ...
                  <span>Explore 10 Examination Modules</span>
                </a>
              </motion.div>
              ...
              <div className="p-7 sm:p-8 rounded-3xl bg-slate-950/90 border border-cyan-900/40 backdrop-blur-2xl shadow-[0_30px_90px_rgba(0,0,0,0.9)] relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between border-b border-slate-800 pb-5 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-mono font-bold text-white uppercase tracking-wider">ACE-V FORENSIC UNIT</span>
                  </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    <Fingerprint className="w-5 h-5 text-[#00d4ff] shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-white font-bold text-sm">Latent Print Chemical Development</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Ninhydrin, cyanoacrylate fuming, fluorescent powders & RUVIS UV lifting.</p>
                    </div>
                  </div>

                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    <Footprints className="w-5 h-5 text-[#00d4ff] shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-white font-bold text-sm">Footwear & Tire Tread Castings</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Electrostatic dust lifting, 3D stone casting & wear pattern matching.</p>
                    </div>
                  </div>

                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    <Wrench className="w-5 h-5 text-[#00d4ff] shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-white font-bold text-sm">Tool Mark Micro-Comparison</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Microscopic comparison of striated & impressed tool marks from break-ins.</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400 text-xs mt-0.5">Sworn opinion certificates & comparative minutiae charts for courts.</p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <span>Call Impression Lab (+91 9890424040)</span>
                </a>
      ...
      {/* ========================================================================= */}
      <section id="fingerprint-services" className="py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-slate-900 border border-slate-800 text-[#00d4ff] text-xs font-mono font-bold uppercase tracking-wider mb-3">
              FINGERPRINT & IMPRESSION MATRIX
            </div>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Fingerprint & Impression <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Capabilities</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              Latent print development, friction ridge comparison, palm print audits, footwear 3D casting, tire track analysis, and tool mark micro-comparisons.
            </p>
            ...
            <div className="inline-flex p-1.5 mt-8 rounded-2xl bg-slate-900/90 border border-slate-800 backdrop-blur-md flex-wrap justify-center gap-1.5 shadow-xl">
              ...
              <button
                onClick={() => setActiveCategory("fingerprints")}
                className={`px-5 py-2.5 rounded-xl font-bold text-xs transition-all duration-300 ${
              ...
              <button
                onClick={() => setActiveCategory("impressions")}
                className={`px-5 py-2.5 rounded-xl font-bold text-xs transition-all duration-300 ${
              ...
              >
                Scene Collection & Litigation Support
              </button>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredServices.map((service, idx) => (
              ...
              >
                ...
                >
                  <span>Request Examination Scope</span>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#00d4ff]/10 text-[#00d4ff] text-xs font-bold uppercase tracking-wider mb-3 border border-[#00d4ff]/30">
              ACE-V Framework Protocol
            </div>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Our 5-Stage ACE-V <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] to-white">Workflow</span>
            </h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed">
              A scientific examination methodology ensuring friction ridge precision, dual peer verification, and court-admissible expert reports.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Skyline Impression Unit</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              ACE-V friction ridge standards, chemical development chambers, and Section 45 expert courtroom testimony.
            </p>
          </motion.div>
          ...
          <div className="p-8 md:p-12 rounded-3xl bg-slate-950/95 border border-[#00d4ff]/40 relative overflow-hidden shadow-2xl">
            ...
            <div className="text-center mb-10 relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900 border border-[#00d4ff]/40 text-xs font-mono font-bold text-[#00d4ff] uppercase tracking-wider mb-4">
                <Mail className="w-3.5 h-3.5 text-[#00d4ff]" /> Confidential Case Intake Request
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-3">
                Schedule Fingerprint & Impression Examination
              </h2>
              <p className="text-slate-400 text-sm max-w-xl mx-auto">
                Submit details regarding disputed fingerprints, palm impressions, footwear castings, or tool marks under strict Non-Disclosure Agreements.
              </p>
            </div>
            ...
            {formStatus === "success" ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white">Examination Request Received</h3>
                <p className="text-slate-300 text-sm max-w-md mx-auto">
                  Thank you for reaching out to Skyline Impression Unit. Our fingerprint specialists will contact you under strict Non-Disclosure Agreements.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      placeholder="e.g. Adv. N. B. Shinde / Defense Advocate"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Law Enforcement Agency">Law Enforcement Agency / Police Unit</option>
                      <option value="Corporate Enterprise">Corporate Enterprise</option>
                      <option value="Private Client">Private Client / Individual</option>
                    </select>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-900 border border-slate-800 text-white focus:outline-none focus:border-[#00d4ff] text-sm transition-all"
                  >
                    <option value="Latent Fingerprint Development & Examination">Latent Fingerprint Development & Comparison</option>
                    <option value="Palm Print Examination & Comparison">Palm Print Examination & Comparison</option>
                    <option value="Footwear & Tire Track Impression Analysis">Footwear & Tire Track Impression Analysis</option>
                    <option value="Tool Mark & Impression Micro-Comparison">Tool Mark & Impression Micro-Comparison</option>
                    <option value="Scene Fingerprint Lifting & Documentation">Scene Fingerprint Lifting & Documentation</option>
                ...
                <div>
                  <label className="block text-xs font-mono font-bold text-slate-300 uppercase tracking-wider mb-2">
                    Evidence Scope & Case Brief
                  </label>
                  <textarea
                    rows={4}
                    placeholder="Provide details on surface media (paper, glass, metal), availability of specimen fingerprint cards, or court trial deadlines..."
                ...
                >
                  {formStatus === "submitting" ? (
                    ...
                    <>
                      <Send className="w-4 h-4" /> Submit Confidential Examination Request
                    </>
                  )}
                </button>

                <p className="text-[11px] text-slate-500 text-center flex items-center justify-center gap-1.5">
                  <Lock className="w-3 h-3 text-[#00d4ff]" /> Evidence disclosures and fingerprint specimen cards remain protected under strict Non-Disclosure Agreements.
                </p>
              </form>
            )}
