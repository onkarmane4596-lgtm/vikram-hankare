...
export default function QuestionedDocumentServicePage() {
  const [activeCategory, setActiveCategory] = useState<"all" | "authentication" | "analysis" | "testimony">("all");
  ...
  const [formData, setFormData] = useState({
    ...
    examinationType: "Forged & Altered Document Examination",
    caseBrief: ""
  });
  ...
  // 10 Core QDE Services Offered
  const servicesList = [
    {
      code: "QDE-AUTH-01",
      title: "Examination of Forged & Altered Documents",
      category: "authentication",
      icon: Search,
      desc: "Microscopic analysis detecting additions, erasures, obliterations, page substitutions, and mechanical manipulations."
    },
    {
      code: "QDE-ANAL-01",
      title: "Handwriting Examination & Comparison",
      category: "analysis",
      icon: PenTool,
      desc: "Scientific evaluation of handwriting characteristics, stroke speed, baseline habits, slant, and writer identification."
    },
    {
      code: "QDE-ANAL-02",
      title: "Signature Examination & Verification",
      category: "analysis",
      icon: CheckCircle2,
      desc: "Authenticating disputed signatures against verified exemplars to detect trace forgery, freehand simulation, or auto-pen."
    },
    {
      code: "QDE-ANAL-03",
      title: "Detection of Erasures, Alterations & Additions",
      category: "analysis",
      icon: Scan,
      desc: "Using Infrared, Ultraviolet, and Video Spectral Comparator (VSC) technology to reveal erased or overwriten text."
    },
    {
      code: "QDE-AUTH-02",
      title: "Printed Document & Counterfeit Examination",
      category: "authentication",
      icon: FileSpreadsheet,
      desc: "Micro-printing analysis, toner/inkjet pattern profiling, resolution audits, and identifying counterfeit certificates or security prints."
    },
    {
      code: "QDE-ANAL-04",
      title: "Ink & Paper Examination",
      category: "analysis",
      icon: Microscope,
      desc: "Nondestructive video spectral analysis of ink formulations, paper fiber composition, watermarks, and age estimation."
    },
    {
      code: "QDE-AUTH-03",
      ...
      category: "authentication",
      icon: Award,
      desc: "Forensic comparison of rubber stamps, embossed seals, official notary impressions, and digital stamp reproductions."
    },
    {
      code: "QDE-AUTH-04",
      title: "Examination of Contracts, Wills & Cheques",
      category: "authentication",
      icon: FileText,
      desc: "Verifying high-value commercial contracts, deeds, probate wills, affidavits, bank cheques, and loan agreements."
    },
    {
      code: "QDE-AUTH-05",
      ...
      category: "authentication",
      icon: ShieldCheck,
      desc: "Auditing passports, national ID cards, driver licenses, land titles, and corporate share certificates for counterfeit elements."
    },
    {
      code: "QDE-TEST-01",
      ...
      category: "testimony",
      icon: Scale,
      desc: "Formulating court-admissible photographic comparison charts, sworn Section 45 expert reports, and delivering courtroom testimony."
    }
  ];

  // 5-Stage Forensic QDE Workflow
  const workflowSteps = [
    {
      step: "01",
      title: "Secure Intake & Preservation",
      desc: "Document receipt under strict evidence logging, tamper-evident protective sleeves, and initial condition recording.",
      tag: "EVIDENCE LOGGING"
    },
    {
      step: "02",
      title: "Non-Destructive Optical Examination",
      desc: "High-resolution stereo-microscopic inspection of line quality, paper fibers, stroke sequence, and indentations.",
      tag: "MICROSCOPIC AUDIT"
    },
    {
      step: "03",
      title: "Spectral & Ink Analysis (VSC)",
      desc: "Infrared luminescence and UV light wavelength analysis to detect overwritten ink layers, erasures, and alterations.",
      tag: "VSC SPECTRAL AUDIT"
    },
    {
      step: "04",
      title: "Comparison Against Exemplars",
      desc: "Side-by-side scientific comparison of disputed signatures/writing against contemporary admitted standard exemplars.",
      tag: "EXEMPLAR COMPARISON"
    },
    {
      step: "05",
      title: "Court-Admissible Report & Testimony",
      desc: "Issuing formal opinion reports with annotated photographic enlargement charts compliant with Section 45 Indian Evidence Act.",
  ...
  const pillars = [
    {
      title: "Certified Forensic Document Examiners",
      desc: "Our laboratory is led by qualified forensic scientists specializing in questioned document examination and handwriting analysis.",
      icon: Microscope,
      node: "01 // QUALIFIED LAB"
    },
    {
      title: "State-of-the-Art Optical Equipment",
      desc: "We utilize Video Spectral Comparators (VSC), stereo-zoom microscopes, and electrostatic detection devices (EDD) for zero-destruction analysis.",
      icon: Eye,
      node: "02 // VSC SPECTRAL TECH"
    },
    {
      title: "Section 45 Indian Evidence Act Compliance",
      desc: "Every report is prepared in accordance with statutory evidence standards for submission in High Courts, District Courts, and Tribunals.",
      icon: Scale,
      node: "03 // JUDICIAL ADMISSIBLE"
    },
    {
      title: "Non-Destructive Testing Protocol",
      desc: "Our analytical methods preserve 100% of the physical integrity of original document evidence without chemical degradation.",
      icon: Lock,
      node: "04 // ZERO DESTRUCTION"
    },
    {
      title: "Strict Evidence Custody & Confidentiality",
      desc: "Original documents are stored in climate-controlled, secure forensic vaults under strict chain-of-custody protocols.",
      icon: ShieldCheck,
    ...
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-[#00d4ff]/30 selection:text-white pb-24 overflow-x-hidden relative">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden border-b border-cyan-900/30 z-10">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img
            src="/design/5.png"
            alt="Questioned Document Examination Background"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-wrap items-center justify-between gap-4 pb-8 mb-8 border-b border-slate-800/80">
            <div className="flex items-center gap-2 text-xs font-mono text-slate-400">
              ...
              <ChevronRight className="w-3 h-3 text-slate-600" />
              <span className="text-[#00d4ff] font-bold">Questioned Document Examination</span>
            </div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/90 border border-slate-800 text-[11px] font-mono text-[#00d4ff]">
              ...
              <span>SERVICE CODE: SRV-QDE-06</span>
            </div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="lg:col-span-7 space-y-6">
              ...
              <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/30 text-xs font-bold text-[#00d4ff] uppercase tracking-widest backdrop-blur-md">
                <Microscope className="w-4 h-4 text-[#00d4ff]" /> FORENSIC DOCUMENT & HANDWRITING EXAMINATION
              </motion.div>
              ...
              <motion.h1 variants={fadeUp} className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-[1.12]">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Examination Services</span>
              </motion.h1>

              <motion.p variants={fadeUp} className="text-slate-300 text-base md:text-lg leading-relaxed font-normal">
                Disputed signatures, altered financial contracts, forged wills, fraudulent land deeds, and counterfeit certificates pose major legal and financial threats to individuals and institutions. At <strong className="text-white font-semibold">Skyline Centre of Excellence</strong>, we provide scientific Questioned Document Examination (QDE) and Forensic Handwriting Verification Services using high-precision optical instruments, video spectral analysis, and legally accepted forensic methodologies to uncover alterations, authenticate signatures, and formulate court-admissible expert reports.
              </motion.p>
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 pt-4">
                ...
                >
                  ...
                  <span>Request Document Examination</span>
                ...
                >
                  ...
                  <span>Explore QDE Capabilities</span>
                </a>
              </motion.div>
              ...
              <div className="p-7 sm:p-8 rounded-3xl bg-slate-950/90 border border-cyan-900/40 backdrop-blur-2xl shadow-[0_30px_90px_rgba(0,0,0,0.9)] relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between border-b border-slate-800 pb-5 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-mono font-bold text-white uppercase tracking-wider">FORENSIC LAB UNIT</span>
                  </div>
                  <span className="text-[10px] font-mono text-[#00d4ff] bg-[#00d4ff]/10 border border-[#00d4ff]/30 px-2.5 py-1 rounded-full uppercase">
                    SECTION 45 IEA VALIDATED
                  </span>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Signature & Handwriting Verification</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Authenticating disputed signatures against standard exemplars.</p>
                    </div>
                  </div>

                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    <Scan className="w-5 h-5 text-[#00d4ff] shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-white font-bold text-sm">VSC Spectral Ink Analysis</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Non-destructive IR/UV optical analysis revealing alterations & erasures.</p>
                    </div>
                  </div>

                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    <FileText className="w-5 h-5 text-[#00d4ff] shrink-0 mt-0.5" />
                    <div>
                      <h4 className="text-white font-bold text-sm">Contracts, Wills & Cheques</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Microscopic examination of deeds, probate wills & commercial papers.</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex items-start gap-3.5">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-sm">Courtroom Expert Testimony</h4>
                      <p className="text-slate-400 text-xs mt-0.5">Sworn Section 45 expert reports & photographic comparison charts.</p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <span>Call QDE Forensic Unit (+91 9890424040)</span>
                </a>
      ...
      {/* ========================================================================= */}
      <section id="qde-services" className="py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-slate-900 border border-slate-800 text-[#00d4ff] text-xs font-mono font-bold uppercase tracking-wider mb-3">
              QDE CAPABILITY MATRIX
            </div>
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Questioned Document <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Capabilities</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              Non-destructive optical inspection, signature verification, ink luminescence parsing, stamp validation, and litigation testimony.
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredServices.map((service, idx) => (
              ...
              >
                ...
                >
                  <span>Request QDE Examination</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950/60 border-y border-slate-800/80 relative z-10">
        <div className="max-w-7xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Our 5-Stage QDE <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] to-white">Workflow</span>
            </h2>
            <p className="text-slate-400 text-sm md:text-base leading-relaxed">
              A scientific examination protocol ensuring zero document damage, microscopic precision, and court-admissible expert reports.
            </p>
          </motion.div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4">
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Skyline QDE Unit</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              Non-destructive optical testing, VSC video spectral comparators, and Section 45 courtroom expertise.
            </p>
          </motion.div>
          ...
          <div className="p-8 md:p-12 rounded-3xl bg-slate-950/95 border border-[#00d4ff]/40 relative overflow-hidden shadow-2xl">
            ...
            <div className="text-center mb-10 relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900 border border-[#00d4ff]/40 text-xs font-mono font-bold text-[#00d4ff] uppercase tracking-wider mb-4">
                <Mail className="w-3.5 h-3.5 text-[#00d4ff]" /> Confidential Document Examination Request
              </div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-3">
                Schedule Questioned Document Examination
              </h2>
              <p className="text-slate-400 text-sm max-w-xl mx-auto">
                Submit details regarding disputed signatures, forged contracts, land deeds, probate wills, or cheques under strict Non-Disclosure Agreements.
              </p>
            </div>
            ...
            {formStatus === "success" ? (
              ...
              >
                ...
                <p className="text-slate-300 text-sm max-w-md mx-auto">
                  Thank you for reaching out to Skyline QDE Unit. Our forensic document experts will review your case details under strict Non-Disclosure Agreements.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      required
                      placeholder="e.g. Adv. R. S. Kulkarni / High Court Advocate"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-900 border border-slate-800 text-white focus:outline-none focus:border-[#00d4ff] text-sm transition-all"
                  >
                    <option value="Forged & Altered Document Examination">Forged & Altered Document Examination</option>
                    <option value="Disputed Signature Verification">Disputed Signature Verification</option>
                    <option value="Handwriting Comparison & Attribution">Handwriting Comparison & Attribution</option>
                    <option value="VSC Ink & Erasure Detection">VSC Ink Wavelength & Erasure Detection</option>
                    <option value="Stamp, Seal & Counterfeit Inspection">Stamp, Seal & Counterfeit Inspection</option>
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    placeholder="Briefly state document type (e.g. Will, Deed, Cheque, Contract), availability of standard exemplars, and court hearing dates if any..."
                ...
                <p className="text-[11px] text-slate-500 text-center flex items-center justify-center gap-1.5">
                  <Lock className="w-3 h-3 text-[#00d4ff]" /> Original documents and case disclosures remain protected under strict Non-Disclosure Agreements.
                </p>
              </form>
            )}
