...
export default function FingerprintTrainingPage() {
  ...
  const whatYouWillLearn = [
    "Fundamentals of Fingerprint Science & Historical Evolution",
    "Fingerprint Classification and Ridge Characteristics (Loop, Whorl, Arch)",
    "Types of Fingerprints: Patent, Plastic, and Latent Prints",
    "Crime Scene Fingerprint Search Techniques & Grid Methods",
    "Development of Latent Fingerprints using Physical and Chemical Methods",
    "Fingerprint Lifting, Preservation, and Chain-of-Custody Documentation",
    "Macro & Alternate Light Source (ALS) Photography of Fingerprint Evidence",
    "Fingerprint Comparison, Minutiae Matching, and Individualization",
    "ACE-V Methodology (Analysis, Comparison, Evaluation, and Verification)",
    "Fingerprint Identification using Modern AFIS/NAFIS Technologies",
    "Preparation of Court-Admissible Fingerprint Examination Reports",
    "Courtroom Procedures, Expert Opinions & Section 45 Testimony"
  ];

  const labExperience = [
    "Development of latent fingerprints on porous, non-porous, and textured surfaces",
    "Black, magnetic, and fluorescent powder dusting and lifting techniques",
    "Cyanoacrylate (Super Glue) fuming chamber demonstrations and development",
    "Chemical development methods using Ninhydrin and DFO for paper surfaces",
    "Digital enhancement and spectrographic isolation of latent fingerprint images",
    "Side-by-side fingerprint comparison, point matching, and exclusion exercises",
    "Crime scene simulation, latent print recovery, and evidence tagging",
    "Preparation of professional fingerprint examination court reports"
  ];

  const careerOpportunities = [
    { title: "Forensic Science Laboratories", desc: "Government & Private FSL Units" },
    { title: "Police & Law Enforcement", desc: "State & Central Bureau Investigators" },
    { title: "Crime Scene Investigation Units", desc: "Mobile Forensic Field Teams" },
    { title: "Private Forensic Consultancies", desc: "Independent Forensic Experts" },
    { title: "Security & Investigation Agencies", desc: "Corporate Fraud & Risk Teams" },
    { title: "Insurance Investigation Services", desc: "Claim Fraud Verification Units" },
    { title: "Government Investigation Depts", desc: "Intelligence & Revenue Audit Units" },
    { title: "Academic & Research Institutions", desc: "Forensic Faculty & Lab Mentors" }
  ];

  const targetAudience = [
    "Students pursuing careers in Forensic Science & Criminology",
    "Police and Law Enforcement Personnel",
    "Crime Scene Investigators & Field Officers",
    "Cyber and Forensic Professionals",
    "Private Detectives & Corporate Investigators",
    "Legal Professionals & Advocates",
    "Security Personnel & Risk Auditors",
    "Anyone interested in forensic identification and fingerprint science"
  ];

  const whyChoosePillars = [
    {
      title: "Hands-on Laboratory Training",
      desc: "Gain practical experience in fingerprint development, examination, and comparison through guided laboratory sessions and crime scene simulations.",
      icon: Microscope
    },
    {
      title: "Experienced Faculty",
      desc: "Learn from forensic experts and experienced professionals with practical expertise in fingerprint examination and crime scene investigations.",
      icon: GraduationCap
    },
    {
      title: "Industry-Relevant Curriculum",
      desc: "The course is designed in line with modern forensic practices and internationally accepted fingerprint examination methodologies (ACE-V).",
      icon: BookOpen
    },
    {
      title: "Career-Focused Learning",
      desc: "Develop job-ready skills through practical exercises, real case studies, and hands-on evidence handling procedures.",
      icon: Briefcase
    },
    {
    ...
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-[#00d4ff]/30 selection:text-white pb-24 overflow-x-hidden relative">
      ...
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 overflow-hidden border-b border-white/[0.06]">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img
            src="/design/5.png"
            alt="Fingerprint Evidence Lab Training Background"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex items-center gap-2 text-xs text-slate-400 mb-8">
            ...
            <ChevronRight className="w-3 h-3 text-slate-600" />
            <span className="text-[#00d4ff] font-medium">Fingerprint Evidence Lab</span>
          </motion.div>
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            ...
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/25 text-xs font-bold text-[#00d4ff] uppercase tracking-widest mb-6 backdrop-blur-md">
              <Fingerprint className="w-3.5 h-3.5 text-[#00d4ff]" /> Hands-on Forensic Training Course
            </motion.div>
            ...
            <motion.h1 variants={fadeUp} className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-6 leading-[1.15]">
              Fingerprint Evidence Lab: <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">From Latent to Matches</span>
            </motion.h1>

            {/* Course Overview */}
            <motion.p variants={fadeUp} className="text-base md:text-lg text-slate-300 leading-relaxed mb-8">
              Fingerprints have long been regarded as one of the most reliable and scientifically accepted forms of personal identification in forensic investigations. The <strong className="text-white font-semibold">Fingerprint Evidence Lab: From Latent to Matches</strong> program offered by <strong className="text-[#00d4ff]">Skyline Centre of Excellence</strong> is a comprehensive, hands-on training course designed to equip participants with practical knowledge and professional skills in fingerprint detection, development, preservation, comparison, and identification using modern forensic techniques and internationally accepted ACE-V standards.
            </motion.p>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Chemical & Powder Lab</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#00d4ff]/10 border border-[#00d4ff]/20 flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-white font-bold text-sm">ACE-V Methodology</p>
                <p className="text-xs text-slate-400">Scientific Comparison</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#00d4ff]/10 border border-[#00d4ff]/20 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">FSL, Police & Corporate Fraud</p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-14">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              Comprehensive curriculum bridging fundamental fingerprint science with advanced laboratory examination and courtroom presentation.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base">
              Work with real-world forensic chemical reagents, alternate light sources, digital comparators, and crime scene simulation scenarios.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/[0.01] border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-base">
              Practical-first laboratory approach, experienced forensic mentors, and professional certification.
            </p>
          </motion.div>
          ...
          <div className="p-8 md:p-12 rounded-3xl bg-gradient-to-b from-white/[0.04] to-white/[0.02] border border-white/10 relative overflow-hidden">
            ...
            <div className="text-center mb-10 relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-3">
                Enroll in Fingerprint Evidence Lab
              </h2>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Law Enforcement / Police">Police / Law Enforcement Officer</option>
                      <option value="Private Investigator">Private Investigator / Corporate Security</option>
                      <option value="Legal Professional">Legal Professional / Advocate</option>
                      <option value="Academic Faculty">Academic Faculty / Researcher</option>
                    </select>
                  </div>
                </div>
