...
export default function FacultyDevelopmentWorkshopPage() {
  ...
  const fdpModules = [
    "Modern Forensic Science & Cyber Security Academic Curriculum Alignment",
    "Designing Practical Laboratory Manuals & Experiment Handouts",
    "Hands-On Tool Mentorship (Autopsy, FTK, Volatility, Wireshark, Burp Suite)",
    "Document & Fingerprint Physical Laboratory Setup Guidance",
    "Research Methodology, Patenting & Paper Publication Mentorship",
    "Academic-Industry Collaboration & Student Placement Preparation",
    "ISO 17025 Laboratory Quality Standards for Academic Institutes",
    "Grant Writing & Research Project Funding Strategies"
  ];
    ...
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans selection:bg-[#00d4ff]/30 selection:text-white pb-24 overflow-x-hidden relative">
      ...
      <section className="relative pt-32 pb-20 lg:pt-44 lg:pb-28 overflow-hidden border-b border-white/[0.06]">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img
            src="/design/5.png"
            alt="Faculty Development Programs Background"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex items-center gap-2 text-xs text-slate-400 mb-8">
            ...
            <ChevronRight className="w-3 h-3 text-slate-600" />
            <span className="text-[#00d4ff] font-medium">Faculty Development</span>
          </motion.div>
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-4xl">
            <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#00d4ff]/10 border border-[#00d4ff]/25 text-xs font-bold text-[#00d4ff] uppercase tracking-widest mb-6 backdrop-blur-md">
              <GraduationCap className="w-3.5 h-3.5 text-[#00d4ff]" /> Empowering Educators &amp; Mentors
            </motion.div>
            ...
            <motion.h1 variants={fadeUp} className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-6 leading-[1.15]">
              Faculty Development <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] via-[#38BDF8] to-white">Programs (FDP)</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="text-base md:text-lg text-slate-300 leading-relaxed mb-8">
              Upskilling academic faculty, professors, and lab directors with industry-aligned forensic science and cybersecurity methodologies, laboratory manuals, and hands-on tool expertise.
            </motion.p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
              FDP Core <span className="text-[#00d4ff]">Modules</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {fdpModules.map((item, idx) => (
